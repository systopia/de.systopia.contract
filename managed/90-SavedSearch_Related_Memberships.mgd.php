          ...
          'columns' => [
            ...
            [
              ...
              'links' => [
                ...
                [
                  'path' => 'civicrm/contract/related-membership/end#?ContractRelatedMembership1=[id]',
                  'icon' => 'fa-ban',
                  'text' => E::ts('End'),
                  'style' => 'default',
                  'conditions' => [
        ...
        'settings' => [
          ...
          'toolbar' => [
            [
              ...
              'style' => 'default',
              'join' => '',
              'path' => 'civicrm/contract/related-membership/add#?contract_id=[owner_membership_id]',
              'task' => '',
              'conditions' => [],
            ],
          ],
