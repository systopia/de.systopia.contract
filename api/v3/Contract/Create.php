...
function _civicrm_api3_Contract_create_spec(&$params) {
  ...
  $params['custom_ch_membership_type'] = array(
      'name'         => 'custom_ch_membership_type',
      'title'        => 'Contract Signup Activity: Membership Type (custom_ch_membership_type)',
      'api.default'  => '',
      'description'  => 'membership type will be shown in Contract Signup Activity Custom Field',
  );
  $params['custom_ch_annual'] = array(
      'name'         => 'custom_ch_annual',
      'title'        => 'Contract Signup Activity: Annual Membership Contribution (custom_ch_annual)',
      'api.default'  => '',
      'description'  => 'Annual Membership Contribution will be shown in Contract Signup Activity Custom Field',
  );
  $params['custom_ch_frequency'] = array(
      'name'         => 'custom_ch_frequency',
      'title'        => 'Contract Signup Activity: Payment Interval (custom_ch_frequency)',
      'api.default'  => '',
      'description'  => 'Payment Interval will be shown in Contract Signup Activity Custom Field',
  );
  $params['custom_ch_cycle_day'] = array(
      'name'         => 'custom_ch_cycle_day',
      'title'        => 'Contract Signup Activity: Cycle Day (custom_ch_cycle_day)',
      'api.default'  => '',
      'description'  => 'Cycle Day will be shown in Contract Signup Activity Custom Field',
  );
  $params['custom_ch_from_ba'] = array(
      'name'         => 'custom_ch_from_ba',
      'title'        => 'Contract Signup Activity:  Members Bank Account ID (custom_ch_from_ba)',
      'api.default'  => '',
      'description'  => 'BankAccount ID will be resolved to the BankAccountReference (eg. Iban) and shown in Contract Signup Activity Custom Field',
  );
