...
// Make CRM_Contract_ExtensionUtil available.
require_once __DIR__ . '/../../contract.civix.php';
 ...
 */
function _contract_test_civicrm_container(ContainerBuilder $container): void {
}
