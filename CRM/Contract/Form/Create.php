...
class CRM_Contract_Form_Create extends CRM_Core_Form {
  ...
  public function postProcess() {
    ...
    \Civi\Api4\Contract::createfull()
      ...
      ->addValue('membership_type_id', $submitted['membership_type_id'])
      ->addValue('start_date', $submitted['start_date'] ?? NULL)
      ->addValue('join_date', $submitted['join_date'] ?? NULL)
      ->addValue('end_date', $submitted['end_date'] ?? NULL)
      ->addValue('membership_reference', $submitted['membership_reference'] ?? NULL)
      ->addValue('membership_contract', $submitted['membership_contract'] ?? NULL)
      ->addValue('membership_channel', $submitted['membership_channel'] ?? NULL)
      ->addValue('payment_option', $submitted['payment_option'])
      ->addValue('recurring_contribution', $submitted['recurring_contribution'] ?? NULL)
      ->addValue('payment_amount', $submitted['payment_amount'] ?? NULL)
      ->addValue('cycle_day', $submitted['cycle_day'] ?? NULL)
      ->addValue('payment_frequency', $submitted['payment_frequency'] ?? NULL)
      ->addValue('iban', $submitted['iban'] ?? NULL)
      ->addValue('bic', $submitted['bic'] ?? NULL)
      ->addValue('account_holder', $submitted['account_holder'] ?? NULL)
      ->addValue('campaign_id', $submitted['campaign_id'] ?? NULL)
      ->execute();
